...
public class GraphCommand extends DiscordCommand {
	...
	public ConfigPage createRemoteConfigurable() {
		...
		conf.add(new ConfigurableOption(this, "Precision", "How precise should the Graph Command be?", OptionType.LIST,
				"defaultSubreddit", new String[] { "1", "0.5", "0.25", "0.2", "0.1", "0.05", "0.01" }));
