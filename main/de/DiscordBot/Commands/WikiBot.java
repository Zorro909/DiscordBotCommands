...
public class WikiBot extends DiscordCommand {
    ...
    public WikiBot() {
        super("wiki", new String[] { "wikipedia", "knowitall" }, "Searches for a certain site on wikipedia!",
                "\\wiki [search]");
    }
    ...
    public Object execute(String command, String[] args, Message m) {
        ...
        if (l.isEmpty()) {
            ...
            eb.setAuthor("Wikipedia", "https://" + lang + ".wikipedia.org/wiki/" + title.replace(" ", "_"), img.get(0));
