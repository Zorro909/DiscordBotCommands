...
public class TranslateCommand extends DiscordCommand {
    ...
    public TranslateCommand() {
        super("translate", new String[] { "trans" }, "Translates a text to a certain Language (default: english)",
    ...
    public Object execute(String command, String[] args, Message m) {
        ...
        synchronized (br) {
            synchronized (pw) {
                ...
                return new MessageBuilder().append("Translated from the language " + resolved + ":")
                        .appendCodeBlock(ret, "").build();
            }
        }
    }
